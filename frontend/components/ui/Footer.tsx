      ...
      <div className="w-full mt-4 px-8  max-w-[1170px]">
        <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="grid justify-between grid-cols-3 gap-4">
            <ul>
              <p className="block mb-3 font-sans text-xl antialiased font-medium leading-normal text-white opacity-90">
                Company
              </p>
              <li>
                <Link
                  href="#"
                  className="block py-1.5 font-sans text-base font-normal leading-relaxed text-gray-400 antialiased transition-colors hover:text-gray-500"
                >
                  About US
                </Link>
              </li>
